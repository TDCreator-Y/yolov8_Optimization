...
```bash
yolo export model=yolov8n_baseline.pt format=onnx # Export yolov8n_baseline model to ONNX
```
...
```bash
python main.py --model yolov8n_baseline.onnx --img image.jpg --conf-thres 0.5 --iou-thres 0.5
```
