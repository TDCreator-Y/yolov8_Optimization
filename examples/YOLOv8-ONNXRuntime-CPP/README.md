...
# Load a YOLOv8 model (e.g., yolov8n_baseline.pt)
model = YOLO("yolov8n_baseline.pt")
...
print("Model exported successfully to yolov8n_baseline.onnx")
```
...
yolo export model=yolov8n_baseline.pt format=onnx opset=12 simplify=True dynamic=False imgsz=640
```
...
fp32_model_path = "yolov8n_baseline.onnx"
